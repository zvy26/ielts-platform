      ...
      <header className="bg-card border-b border-border px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden sm:flex items-center gap-2 bg-orange-50 dark:bg-orange-950 px-3 py-2 rounded-lg">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-6 sm:py-8">
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
            <div className="xl:col-span-2">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">Complete IELTS Preparation Course</h1>
              <p className="text-base sm:text-lg mb-6 text-green-50 leading-relaxed">
              ...
              <div className="flex flex-wrap items-center gap-4 sm:gap-6 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm sm:text-base">15,000+ students</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4 sm:w-5 sm:h-5" />
                  <span className="text-sm sm:text-base">6 months access</span>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="bg-green-600 px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm flex items-center gap-1">
            ...
            <div className="xl:col-span-1">
              <Card className="bg-white text-gray-900">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <Button className="w-full bg-green-600 hover:bg-green-700 text-white mb-4 py-2 sm:py-3">
                    Start Learning Now
                  </Button>
      ...
      <main className="w-full flex-1">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-6 sm:py-8">
          <div className="w-full grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
            {/* Course Content */}
            <div className="xl:col-span-2">
              <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-2">Course Content</h2>
              <p className="text-muted-foreground mb-4 sm:mb-6">12 units • 36 sessions • 216 lessons</p>

              <div className="space-y-3 sm:space-y-4">
                {courseUnits.map((unit, index) => (
                  <Card key={index} className="border border-border w-full">
                    <CardContent className="p-0">
                      ...
                      >
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs sm:text-sm text-muted-foreground mt-1">{unit.description}</p>
                        </div>
                        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 ml-2">
                          <span className="text-xs sm:text-sm text-muted-foreground">{unit.sessions} sessions</span>
                          <ChevronDown
                          ...
                          <div className="space-y-2">
                            {[1, 2, 3].map((session) => (
                              <div key={session} className="flex items-center gap-3 py-2">
                                ...
                                <span className="text-xs sm:text-sm text-foreground">Session {session}</span>
            ...
            <div className="xl:col-span-1 space-y-4 sm:space-y-6">
              ...
              <Card className="w-full">
                <CardContent className="p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-semibold text-foreground mb-4">Course Features</h3>
              ...
              <Card className="w-full">
                <CardContent className="p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-semibold text-foreground mb-4">IELTS Skills Covered</h3>
                  <div className="space-y-3">
                    {skillsData.map((skill, index) => (
                      <div key={index} className="flex items-center gap-3">
                        <div
                          className={`w-7 h-7 sm:w-8 sm:h-8 ${skill.color} rounded-lg flex items-center justify-center`}
                        >
                          <skill.icon className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
                        </div>
